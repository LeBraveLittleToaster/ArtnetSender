...
Since the application is currently not in an operational usable state, please follow the develop branch for the current version.
...
equipment, organize vendor and category information, and manage maintenance states so
rentals and event prep stay reliable. The server provides the backend needed to keep
stock, availability, and operational details in one place for day-to-day work.
