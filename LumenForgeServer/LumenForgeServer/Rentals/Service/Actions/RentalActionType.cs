...
public static class RentalActionTypeExtensions
{
    public static List<Permissions> GetNeededPermissions(this RentalActionType actionType)
    {
        return actionType switch
        {
            ...
            RentalActionType.ApproveRequest => [Permissions.RentalActionCall],
            RentalActionType.RejectRequest => [Permissions.RentalActionCall],
            RentalActionType.AssignItems => [Permissions.RentalActionCall],
            RentalActionType.RemoveItems => [Permissions.RentalActionCall],
            RentalActionType.ApproveItems => [],
            RentalActionType.RejectItems => [],
            RentalActionType.GenerateChecklist => [Permissions.RentalActionCall],
            RentalActionType.ScanChecklist => [Permissions.RentalActionCall],
            RentalActionType.SignChecklist => [Permissions.RentalActionCall],
            RentalActionType.RecordPickup => [Permissions.RentalActionCall],
            RentalActionType.RecordReturn => [Permissions.RentalActionCall],
            RentalActionType.RequestExtension => [],
            RentalActionType.ApproveExtension => [Permissions.RentalActionCall],
            RentalActionType.RejectExtension => [Permissions.RentalActionCall],
            RentalActionType.RecordDamages => [],
            RentalActionType.CreateMaintenanceJobs => [Permissions.RentalActionCall],
            RentalActionType.GenerateInvoice => [Permissions.RentalActionCall],
            RentalActionType.RecordPayment => [Permissions.RentalActionCall],
            RentalActionType.GenerateReport => [Permissions.RentalActionCall],
            RentalActionType.CompleteRental => [Permissions.RentalActionCall],
            RentalActionType.CancelRental => [],
            RentalActionType.ScrapRental => [Permissions.RentalActionCall],
